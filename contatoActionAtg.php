...
<?php 
    ...
    $msg = false;
     ...
     if(isset($_FILES['arquivo1'])){
        ...
        $sql_code = "INSERT INTO contato (nome, email, titulo, subtitulo, cidade, noticia1, noticia2, imagem1, imagem2) 
        VALUES ('$nome', '$email', '$titulo', '$subtitulo', '$cidade', '$noticia1', '$noticia2', '$novo_imagem', '$novo_imagem2')";
