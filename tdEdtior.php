...
<head>
  ...
  <title>Notícias Recebidas </title>
</head>
...
<body>
  ...
  <div>
    <div class="w3-container w3-padding-32" id="noticias">
      <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16 w3-center" style="margin-top: 60px;">Todas as Notícias recebidas</h3>
    </div>
    ...
    $sql = "SELECT * FROM tcc.contato ORDER BY idcontato DESC;" ;
    ...
    foreach($resultado as $teste){
      echo '<div class="w3-row" style="margin-left: 40px;" id="'.$teste['idcontato'].'"> ';
      echo '<div class="w3-col l3 m6 w3-margin-bottom"> ';
      echo '<div class="w3-display-container">';
      echo '<a href="PEditor.php?id='.$teste['idcontato'].'" class="w3-button"><img src="uploadContato/'.$teste['imagem1'].'" style="width:100%"></a>';
      echo '</div>';
      echo '</div>';
      echo '<div class="w3-half w3-padding-64" style="padding-left: 64px">';
      echo '<a href="file:///D:/TCC/noticia3-09.html">';
      echo '<div class="w3-display-container">';
      echo '<a href="PEditor.php?id='.$teste['idcontato'].'" class=""> <h1 class="w3-xlarge" style="font-weight: bold;">';
      echo $teste['titulo'];
      echo '</h1> </a>';
      echo '</div>';
      echo '</a>';
  ...
  <!-- creditos -->
  <footer class="w3-center w3-black w3-padding-16" style="margin-top: 46%;">
